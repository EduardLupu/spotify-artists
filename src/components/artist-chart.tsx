    ...
    if (metricTab === "audience") {
      ...
      if (showUnique) {
        ...
        if (typeof latest.followers === "number") {
          parts.push(`${tooltipValueFormatter(latest.followers)} followers`)
        }
      }
                      ...
                      <AreaChart data={filteredData}>
                        ...
                        {filteredData.some((d) =>
                            ...
                            <Area
                                ...
                                strokeWidth={2}
                                dot={false}
                                activeDot={{ r: 4, fill: "#1ED760", strokeWidth: 0 }}
                            />
                        )}
                      </AreaChart>
                    </ResponsiveContainer>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={filteredData}>
                    ...
                    <Tooltip
                        ...
                        content={
                          <ChartTooltipContent labelFormatter={(value) => formatShortDate(value as string)} indicator="dot" />
                        }
                    />
                    {!showUnique && (
                        <Area
